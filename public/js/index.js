...
let loginBox = () => {
    return `<div>
        ...
        <button id="btnGoTo" onclick="window.location.href = 'https://smallcase-v2.onrender.com/signup'" class="border border-blue-600 text-sm p-4 block m-auto w-4/5 text-blue-600 font-semibold mb-5 rounded">Open an account online</button>
    </div>
...
if(localStorage.getItem("login_detail") != null) {
    ...
    if(partner == login_detail.user.partner) {
        window.location.href = "https://smallcase-v2.onrender.com/discover";
    }
    else {
