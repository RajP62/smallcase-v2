if(localStorage.getItem("login_detail") == null) {
    ...
    if(user=="user"|| token == "token"){
        ...
        window.location.href = "https://smallcase-v2.onrender.com/login";
    }
...
async function authenticate(token,user) {
    const match = await fetch("https://smallcase-v2.onrender.com/discover/auth",{
        method: 'GET',
        headers: {
...
let getSmallcases = async ()=>{
    let data = await fetch(`https://smallcase-v2.onrender.com/smallcases/all`);
...
function searchData(elem){
    ...
    window.location.assign("https://smallcase-v2.onrender.com/search");
}
    ...
    <div class=" w-full h-16 border-b border-gray-400 flex"> 
       <div class="h-full flex ml-28 space-x-7">
           <div class=" h-full py-3">
               <img class="h-full" src="https://smallcase-v2.onrender.com/images/groww-logo.png">
           </div>
           <button onclick="window.location.href = 'https://smallcase-v2.onrender.com/growDashboard'" class="text-gray-600 text-sm">Dashboard</button>
           <button onclick="window.location.href = 'https://smallcase-v2.onrender.com/discover'" class="text-gray-600 text-sm">Discover</button>
           <button onclick="window.location.href = 'https://smallcase-v2.onrender.com/create'" class="text-gray-600 text-sm">Create</button>
       </div>
       <div class="h-full flex ml-auto mr-28 space-x-7">
           <button class="text-gray-600 text-sm" onclick="window.location.href ='https://smallcase-v2.onrender.com/watchlists'">Watchlist</button>
           <button class="text-gray-600 text-sm" onclick="window.location.href ='https://smallcase-v2.onrender.com/investments'">Investments</button>
...
function footer(){
    ...
    <div class=" w-full h-44 bg-gray-100 mt-20">
        <div class="w-full h-20 flex ">
            ...
            <div class="ml-20"> 
                <img class="h-10 p-1" src="https://smallcase-v2.onrender.com/images/groww-logo.png">
...
function logout() {
    ...
    window.location.href="https://smallcase-v2.onrender.com/home"
}
